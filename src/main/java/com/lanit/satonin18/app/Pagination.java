...
//        public EmptyPagination(Pagination pageImpl) {
//            super(1, pageImpl.maxResult, pageImpl.maxNavigationPage);
//
//            totalRecords = 0;
//            currentPage = 1;
//            list = Collections.EMPTY_LIST;//new ArrayList();
//            maxResult = pageImpl.maxResult;//getMaxResult();
//            totalPages = 1;
//            maxNavigationPage = pageImpl.maxNavigationPage;//getMaxNavigationPage();
